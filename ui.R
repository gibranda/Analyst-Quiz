...
likelihood to find the analyst, the larger the search area."),
            ...
            em("The probability region shown was simulated using an ", a("adaptive 
            ...
            p(a("Code for this app", href = "https://github.com/pviefers/Analyst-Quiz"), " available at GitHub. R code to do simulation is ", a("here.", href="https://github.com/pviefers/Analyst-Quiz/blob/master/R_code_for_solution.R"))
        ),
